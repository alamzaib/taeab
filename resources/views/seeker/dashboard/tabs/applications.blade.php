@php
    $applications = $seeker->applications()->with('job.company')->latest()->paginate(10);
@endphp

<h2 class="primary-text" style="margin:0 0 24px; font-size:28px;">My Applications</h2>
<p style="color:#64748b; margin-bottom:24px;">Track your submissions and continue conversations with employers.</p>
